...
import heroBg from "../../images/bg-homepage.jpg";
import logoLg from "../../images/logo/logo-lg.svg";
import logoSm from "../../images/logo/logo-sm.svg";
import toggleImg from "../../images/theme/theme-toggle-night.svg";
import toggleImgActive from "../../images/theme/theme-toggle-night-active.svg";
import userIcon from "../../images/user/user-icon.svg";
import userIconActive from "../../images/user/user-icon-active.svg";
import menuBurger from "../../images/menu/menu-burger.svg";
import menuBurgerActive from "../../images/menu/menu-burger-active.svg";
import { Link } from "react-router-dom";

export const HeaderForPages = styled.div`
    height: 150px;
    overflow: hidden;
